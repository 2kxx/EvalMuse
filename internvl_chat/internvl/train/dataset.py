...
def add_gaussian_noise(img, mean=0.0, std=0.05, p=0.1):
    if random.random() < p:
...
def build_transform(is_train, input_size, pad2square=False, normalize_type='imagenet'):
    ...
    if is_train:  # use data augumentation
        transform = T.Compose([
            ...
            T.RandomApply([T.RandomResizedCrop(input_size, scale=(0.8, 1.0), ratio=(0.9, 1.1))], p=0.1),
            # T.RandomApply([T.RandomRotation(degrees=10)], p=0.1),
