...
def main():
    ...
    token_list = [IMG_START_TOKEN, IMG_END_TOKEN, IMG_CONTEXT_TOKEN,
                  ...
                  REF_END_TOKEN, BOX_START_TOKEN, BOX_END_TOKEN, '<score1>', '<score2>', '<score3>', '<score4>']
    ...
    # model.deepmlp1._initialize_weights()
    # model.deepmlp2._initialize_weights()
    # for module in model.score_hidden_fcs:
    #     for layer in module:
