...
# target_texts = ['excellent', 'good', 'fair', 'poor', 'bad']
# token_index5 = tokenizer.encode('excellent')[0]
# token_index4 = tokenizer.encode('good')[0]
# token_index3 = tokenizer.encode('fair')[0]
# token_index2 = tokenizer.encode('poor')[0]
# token_index1 = tokenizer.encode('bad')[0]
# logits = response.logits
# probs = F.softmax(logits, dim=-1)
# prob5 = probs[0, token_index5].item()
# prob4 = probs[0, token_index4].item()
# prob3 = probs[0, token_index3].item()
# prob2 = probs[0, token_index2].item()
